...
function getWeather(latitude, longitude) {
  ...
  let api =
    `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&lang=${CONFIG.language}&appid=${key}`;
  fetch(api)
...
function displayWeather() {
  ...
  tempElement.innerHTML = `${weather.temperature.value.toFixed(0)
